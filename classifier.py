...
for line in reader:
	full_set.append(line['name'])
	response_full.append(line['index'])
...
docs_new = ['fish rice', 'shrimp curry','fish fry','servicing','food',
		'achari murg','egg sandwhich','chicken changezi','disgusting']
